...
| <h3>**Features Testing**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Test Case 1: Landing page appeared as per shown in Fig 1 when page is loaded or refreshed**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Expected:** The landing page shall appear as per Fig 1.<br/>**Test:** Refresh the page.<br/>**Result:** The  Landing page appeared as per shown in Fig 1 when page is loaded or refreshed.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Test Case 2: Floating Label moved higher after clicked into the query boxes**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Expected:** The floating label "Type a read name/street name/bus stoop code" shall move higher when clicked onto the query boxes.<br/>**Test:** Click onto the query boxes.<br/>**Result:** The floating label "Type a read name/street name/bus stoop code" moved higher when clicked onto the query boxes.<br/>                                                                                                                                                                                                                                                                                                |
...
| **Expected:** The autocomplete menu shall appear if less than 4 characters are typed into the query boxes.<br/>**Test:** Type in less than 4 characters in the query boxes.<br/>**Result:** The autocomplete menu does not appeared when less than 4 characters are typed into the query boxes.<br/>                                                                                                                                                                                                                                                                                                               |
...
| **Test Case 6: Warning popout appeared for user queries of invalid contents in the query boxes**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Expected:** A warning popout shall appear if invalid contents of more than 4 characters are typed into the query boxes.<br/>**Test:** Type in more than 4 characters of invalid content.<br/>**Result:** A warning popout appeared if invalid contents of more than 4 characters are typed into the query boxes.<br/>                                                                                                                                                                                                                                                                                            |
...
| **Expected:** After clicking the search button, the starting point marker and destination marker shall appear on the map based on the locations of the bus stop in the "FROM" and "TO" query boxes and information of these 2 bus stop shall appear onto the starting point and destination bus stop information cards respectively.<br/>**Test:** Click the search button.<br/>**Result:** Starting point marker and destination marker appeared on the map based on the locations of the bus stop in the "FROM" and "TO" query boxes and information of these 2 bus stops appeared onto the starting point and destination bus stop information cards respectively after clicking the search button.<br/> 
...
| **Expected:** After clicking the search button, the starting point marker shall appear on the map based on the location of the bus stop in the "FROM" query boxes and information of the bus stop shall appear onto the starting point bus stop information cards.<br/>**Test:** Click the search button.<br/>**Result:** Starting point marker appeared on the map based on the location of the bus stop in the "FROM" query box and information of the bus stop appeared onto the starting point bus stop information card after clicking the search button.<br/> 
...
| **Expected:** After clicking the search button, the destination marker shall appear on the map based on the location of the bus stop in the "TO" query box and information of the bus stop shall appear onto the destination bus stop information cards.<br/>**Test:** Click the search button.<br/>**Result:**  Destination marker appeared on the map based on the location of the bus stop in the "TO" query box and information of the bus stop appeared onto the destination information card after clicking the search button.<br/>
| **Test Case 11: Content in the  query boxes remained after clicking the search button**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Expected:** The content in the query boxes shall remain after clicking the search button.<br/>**Test:** Remove some of the information in the query boxes before clicking the search button.<br/>**Result:** The content in the query boxes remained after clicking the search button.<br/>                                                                                                                                                                                                                                                                                                                      |
| **Test Case 12: All the markers on the map and contents in query boxes are removed after clicking onto the query boxes**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Expected:** The content in the query boxes and markers shown on the map shall be removed after clicking onto the query boxes.<br/>**Test:** Click onto the query boxes.<br/>**Result:** The content in the query boxes and markers shown on the map are removed after clicking onto the query boxes.<br/>                                                                                   
| **Test Case 13: The map focused onto the selected bus stop, with a white arrow marker and the bus stop information is shown onto the bus stop information card after user clicked onto the bus stop icon from the map**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Expected:** The map shall focus onto the selected bus stop with a white arrow marker and the bus stop information shall be shown onto the bus stop information card.<br/>**Test:** Click onto any of the bus stop icon on the map. <br/>**Result:** The map focused onto the selected bus stop, with a white arrow marker and the bus stop information is shown onto the bus stop information card after user clicked onto the bus stop icon on the map.<br/>                                                                             
| **Test Case 14: The white marker arrow moved to the selected bus stop on the map and the information on the bus stop information card changed as accordingly after user clicked onto different bus stop icon from the map**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Expected:** The white marker arrow shall move to the selected bus stop on the map and the information on the bus stop information card shall change as accordingly after user clicked onto different bus stop icon from the map.<br/>**Test:** The white marker arrow moved to the selected bus stop on the map and the information on the bus stop information card changed as accordingly after user clicked onto different bus stop icon on the map.<br/>
